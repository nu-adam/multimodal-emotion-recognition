...
class Decoder(nn.Module):
    ...
    def forward(self, fused_features):
        ...
        Args:
            fused_features (torch.Tensor): Batch of fused features of shape: (batch_size, fused_dim).

        Returns:
            torch.Tensor: Predicted probabilities for each class of shape: (batch_size, num_classes).
        """
